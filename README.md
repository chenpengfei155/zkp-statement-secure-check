...
To install CirVerify, you can clone the repository and install the required dependencies:
...
1. **Basic Analysis:**
   ...
   ```bash
   cirverify path/to/your/file.circom
   ```
...
2. **Generate JSON Report:**
   ...
   ```bash
   cirverify path/to/your/file.circom --json path/to/output/report.json
   ```
...
```bash
> cirverify .\demo.circom --json .\result.json
